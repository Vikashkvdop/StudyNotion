...
export default function CourseInformationForm() {
  ...
  useEffect(() => {
    const getCategories = async () => {
      ...
      if (categories.length > 0) {
        ...
        console.warn("Invalid or empty categories response:", categories)
      }
  ...
  return (
    <form
      ...
      className="space-y-8 rounded-md border-[1px] border-gray-700 bg-gray-900 p-6"
    >
      {/* Course Title */}
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-gray-200" htmlFor="courseTitle">
      ...
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-gray-200" htmlFor="courseShortDesc">
      ...
      {/* Course Price */}
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-gray-200" htmlFor="coursePrice">
      ...
      {/* Course Category */}
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-gray-200" htmlFor="courseCategory">
      ...
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-gray-200" htmlFor="courseBenefits">
