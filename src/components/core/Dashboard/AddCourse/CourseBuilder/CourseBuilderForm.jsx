...
export default function CourseBuilderForm() {
  ...
  return (
    <div className="space-y-8 rounded-md border-[1px] border-gray-700 bg-gray-900 p-6">
      <p className="text-2xl font-semibold text-gray-200">Course Builder</p>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="flex flex-col space-y-2">
          <label className="text-sm text-gray-200" htmlFor="sectionName">
