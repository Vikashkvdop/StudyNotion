  ...
  return (
    <div>
      ...
      <form onSubmit={handleOnSubmit} className="flex w-full flex-col gap-y-4">
        <div className="flex gap-x-4">
          <label>
            ...
            <input
              ...
              className="w-full rounded-[0.5rem] bg-gray-800 p-[12px] text-gray-200"
            />
          </label>
          <label>
            <p className="mb-1 text-[0.875rem] leading-[1.375rem] text-gray-200">
        ...
        <div className="flex gap-x-4">
          <label className="relative">
            ...
            <input
              ...
              className="w-full rounded-[0.5rem] bg-gray-800 p-[12px] pr-10 text-gray-200"
            />
            <span
        ...
        <button
          type="submit"
          className="mt-6 rounded-[8px] bg-yellow-300 py-[8px] px-[12px] font-medium text-black"
        >
          Create Account
        </button>
      </form>
